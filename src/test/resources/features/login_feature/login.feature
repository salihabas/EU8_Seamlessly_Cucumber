Feature: Login function
  ...
  Scenario Outline: User doesn't login with invalid username
    When user enters "<username>" as a username
    And user enters "<password>" as a password
    And user clicks login button
  ...
  Scenario: User doesn't login with absent username and correct password
  ...
  Scenario: User doesn't login with correct username and absent password
  ...
  Scenario: User can see the Forgot password and Reset Password
